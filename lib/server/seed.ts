...
const templates: AgentTemplate[] = [
  ...
  },
  {
    ...
    description: "Upstream OpenClaw gateway/runtime container, managed by Sidekicks as an external agent system.",
    icon: "FileSearch",
    kind: "runtime",
    category: "Research",
    ...
    featured: false,
    exampleUseCases: ["Upstream OpenClaw gateway", "External runtime validation"],
    configSchema: {
      env: [
